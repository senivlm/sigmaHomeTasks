...
namespace task2_set
{
    ...
    class Meat : Product
    {
        public Meat(string _name, int _weight, double _price, int _expirationDate, DateTime _creationTime, Sort _sort, Type _type) :
        ...
        public Meat() : base() { this.SortOfTheProduct = Sort.Second; this.TypeOfTheProduct = Type.Chicken; }
